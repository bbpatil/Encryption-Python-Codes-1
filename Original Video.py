...
out = cv2.VideoWriter('C:/...thevideo org.mp4',fourcc, 20.0, (w,h))
num=w*h
...
videoclip = VideoFileClip("C:/...thevideo org.mp4") 
audioclip = AudioFileClip("C:/...theaudio org.mp3")

# New Video Destination
new_audioclip = CompositeAudioClip([audioclip])
videoclip.audio = new_audioclip
videoclip.write_videofile("C:/...Original Video.mp4")