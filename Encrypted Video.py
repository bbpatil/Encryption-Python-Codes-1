...
out = cv2.VideoWriter('C:/...thevideo e.mp4',fourcc, 20.0, (w,h))
num=w*h
...
videoclip = VideoFileClip("C:/...thevideo e.mp4") 
audioclip = AudioFileClip("C:/...theaudio e.mp3")

# New Video Destination
new_audioclip = CompositeAudioClip([audioclip])
videoclip.audio = new_audioclip
videoclip.write_videofile("C:/...Encypted Video.mp4")
